  ...
  return (
    <div
      className={`${
        active === title
          ? "lg:h-[470px] bg-black"
          : " lg:h-[407px] bg-[#F5F5F5]"
      } w-full lg:w-[350px] h-[407px] sm:h-[270px]  relative font-DMSans flex flex-col gap-[20px] justify-center items-center sm:items-start lg:items-center p-[40px]`}
    >
      {active === title && (
