...
const Footer = () => {
    ...
    return (
      <div className="flex gap-[11px]">
        ...
        >
          ...
          <path
            className="fill-white group-hover:fill-[url(#a)]"
        ...
        >
          ...
          <path
            className="fill-white group-hover:fill-[url(#b)]"
        ...
        >
          ...
          <path
            className="fill-white group-hover:fill-[url(#c)]"
        ...
        >
          ...
          <path
            className="fill-white group-hover:fill-[url(#d)]"
        ...
        >
          ...
          <path
            className="fill-white group-hover:fill-[url(#e)]"
  ...
  return (
    <animated.footer
      style={{ ...animatedPage }}
      className={
        "bg-black flex items-center justify-center h-[539px] sm:h-[284px] lg:h-[250px]"
      }
    >
      <div className="w-10/12 flex flex-col sm:flex-row justify-between items-center gap-[120px]">
        <div className="w-fit flex flex-col sm:flex-row gap-[45px] sm:gap-[100px]">
              ...
              <ul className="hidden sm:flex lg:hidden flex-row justify-center items-center gap-[14px] text-[12px] h-fit font-DMSans">
                ...
                {links.map((l, index) => {
                  return (
                    <li
                      key={index}
                      className="font-semibold text-white hover:text-white/30"
                    >
          ...
          <ul className="flex sm:hidden lg:flex flex-col justify-center items-center gap-[14px] text-[12px] h-fit font-DMSans">
            <li className="font-semibold text-white hover:text-white/30">
              <Link to={"/"}>{"HOME"}</Link>
            </li>
            {links.map((l, index) => {
